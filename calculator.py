...
me=Tk()
me.geometry("500x500")
me.title("ISHU CALCULATOR")
melabel = Label(me,text="ISHU CALCULATOR",bg='#ffffb3',font=("Times",30,'bold'))
melabel.pack(side=TOP)
me.config(background='#ff6666')
...
metext=Entry(me,font=("Courier New",12,'bold'),textvar=textin,width=25,bd=5,bg='#80bfff')
metext.pack()
